About pysftp-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pysftp-feedstock/blob/main/LICENSE.txt)
...
Development: https://bitbucket.org/dundeemt/pysftp
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4146&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pysftp-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pysftp` can be installed with `conda`:
...
```
mamba install pysftp
```

It is possible to list all of the versions of `pysftp` available on your platform with `conda`:
...
```
mamba search pysftp --channel conda-forge
```
...
mamba repoquery search pysftp --channel conda-forge

# List packages depending on `pysftp`:
mamba repoquery whoneeds pysftp --channel conda-forge

# List dependencies of `pysftp`:
mamba repoquery depends pysftp --channel conda-forge
```
